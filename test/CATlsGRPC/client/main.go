...
func main() {
	...
	certificate, err := tls.LoadX509KeyPair(
		"/Users/yao/Documents/rongzer/gowork/src/gmssl-go/test/CATlsGRPC/cakey/client.crt",
		"/Users/yao/Documents/rongzer/gowork/src/gmssl-go/test/CATlsGRPC/cakey/client.key")
	if err != nil {
		log.Fatal(err)
	}
	certPool := x509.NewCertPool()
	ca, err := ioutil.ReadFile("/Users/yao/Documents/rongzer/gowork/src/gmssl-go/test/gmCATlsGRPC/cakey/ca.crt")
	if err != nil {
		log.Fatal(err)
	}
