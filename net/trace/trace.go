...
*/
package trace // import "github.com/rongzer/gmssl-go/net/trace"
...
import (
	...
	"github.com/rongzer/gmssl-go/net/internal/timeseries"
)
...
func init() {
	...
	if pat == debugRequestsPath {
		panic("/debug/requests is already registered. You may have two independent copies of " +
			"github.com/rongzer/gmssl-go/net/trace in your binary, trying to maintain separate state. This may " +
...
var contextKey = contextKeyT("github.com/rongzer/gmssl-go/net/trace.Trace")
